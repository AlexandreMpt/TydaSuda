    ...
    <section class="profile" id="profile">
        <div class="container">
            <div class="profile__navbar">
                ...
                <a v-if="showAdminPanel" href="" class="profile__navbar__btn active-btn">Админ панель</a>
            </div>
        </div>
    </section>
</template>
        ...
        async fetchUserData() {
            try {
                ...
                if (loggedInUsers.length > 0) {
                    ...
                    // Определяем видимость ссылки на админ панель
                    this.showAdminPanel = this.user.role === 'Администратор';
